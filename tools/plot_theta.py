...
def solname_to_id(molecule, restart="restart"):
    ...
    sol_list = [
        key
        for key in restart_obj.solutesdic
        if restart_obj.solutesdic[key].lower() in molecule.lower()
    ]
    gcsol_list = [
        key
        for key in restart_obj.gcsolutesdic
...
if __name__ == "__main__":
    ...
    thetas_dic = find_solute_theta(
        args.molecule, args.restart, args.results, skip_steps
    )
