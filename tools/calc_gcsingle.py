...
import sys
sys.path.append("/local/scratch/gar1c13/ProtoMS3.0/tools")
...
if __name__ == '__main__' :
  ...
  #parser.add_argument('-d','--directories',help="the naming scheme of the GCMC results directories. Multiple folders can be speficied within inverted commas, default='out*'",default="out*")
  ...
  parser.add_argument('-p','--plot',help="whether to plot the estimated excess chemical potential against Adams value",default=True)
  parser.add_argument('-r','--range',nargs="+",help="range of Adams value from which the free energy will be calculated.",default=None)
