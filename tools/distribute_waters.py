...
if __name__ != "__main__":
    ...
    from . import convertwater, rotatesolute
    # print (convertwater, simulationobjects)

logger = logging.getLogger('protoms')


def create_res(atnames=["O00"],
               resname="sol",
...
def distribute_particles(box,
    ...
    if isinstance(particles, str) and particles.isdigit():
        ...
        for i in range(1, watnumb + 1):
            ...
            particles.solvents[i] = create_res(
                resname=resname, positions=[oxpos])
        particles = convertwater.convertwater(
        ...
        if partnumb is not None:
            ...
            for i in range(1, int(partnumb) + 1):
                ...
                particles.residues[i] = create_res(
...
if __name__ == "__main__":
    __package__ = "distribute_waters"
    import simulationobjects
    from convertwater import convertwater, rotatesolute
