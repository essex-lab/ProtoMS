...
parser = argparse.ArgumentParser(
    description="Script to parse move histograms from ProtoMS dihedral tuning"
...
parser.add_argument(
    ...
    "--accept_file",
    required=True,
    help="simulation accept file containing histograms",
)
parser.add_argument(
    "-t",
    "--tem_file",
    required=True,
    help="template file to update with new flexibilities",
)
parser.add_argument(
    "-o", "--output", required=True, help="output template file"
)
