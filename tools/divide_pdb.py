...
Initially thought to divide the multi-snapshot pdb file produced as ProtoMS
output into individual snapshot pdb files.
...
def divide_print(common, prefix):
    ...
    filenames = [
        prefix + "%d.pdb" % (i + 1) for i, eachpdb in enumerate(pdbset.pdbs)
    ]
