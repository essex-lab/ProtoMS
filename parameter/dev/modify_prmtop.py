...
parser.add_argument(
    ...
    "--infile",
    required=True,
    help="Name of input topology file to be modified.",
)
parser.add_argument(
    "-o", "--outfile", required=True, help="Name of output topology file."
)
...
sidechain_impropers = {
    ...
    "ASP": (("OD2", "CG", "OD1", "CB"),),
    "GLN": (("OE1", "CD", "NE2", "CG"), ("CD", "HE21", "NE2", "HE22")),
    "GLU": (("OE2", "CD", "OE1", "CG"),),
    "HIS": (
        ("CB", "CD2", "CG", "ND1"),
        ("HD2", "CD2", "NE2", "CG"),
...
for i, chnk in enumerate(prmtop.chunks(s.vals + s2.vals, 5)):
    ids = map(prmtop.ptoi, map(abs, chnk[:4]))
