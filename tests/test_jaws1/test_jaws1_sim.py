...
class TestJAWS1(unittest.TestCase):
    ...
    def test_jaws(self):
        ...
        self.assertEqual(0, call("python2.7 $PROTOMSHOME/protoms.py -s jaws1 -p protein.pdb -l fragment.pdb --nequil 0 --nprod 100 --ranseed 100001 --setupseed 100000 --dumpfreq 10 -w water.pdb", shell=True))
        ...
        self.assertEqual(0, call("$PROTOMSHOME/build/protoms3 run_jaws.cmd", shell=True))
