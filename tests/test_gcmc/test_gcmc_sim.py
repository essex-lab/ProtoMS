...
class TestGCMC(unittest.TestCase):
    ...
    def test_gcmc(self):
        ...
        if((call("python2.7 $PROTOMSHOME/protoms.py -sc protein.pdb -s gcmc --gcmcwater wat.pdb --gcmcbox gcmc_box.pdb --adams 19 20 --nequil 0 --nprod 1000 --ranseed 100000 --dumpfreq 100 --capradius 26 -w water.pdb --gaff gaff14", shell=True)) == 0):
